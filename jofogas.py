...
client = mqtt.Client(client_id=f"jofogas-{uuid.uuid4()}")
valid_listing_html = []
...
def on_connect(client, userdata, flags, rc):
    client.subscribe("router/jofogas/raw")
    client.subscribe("kill/jofogas")
    client.publish("status", "jofogas")
